...
ssp245='SSP245'
model='UKESM1'
ODMS_file = sorted(glob.glob('/nesi/project/niwa02757/ybh10/CMIP6/Oceanic_DMS/*{}*.nc'.format(model)))
...
def process_cmip6(number_of_files_in_one,): 
    """
...
for f in (files):
    for x in (f):
        if x.find (name[0]) !=-1:  # Oceanic DMS
            print(x)
